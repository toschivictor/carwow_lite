class ShowroomController < ApplicationController
  def index
    @cars = [
      ...
      {make: 'Mercedes',   model: 'C-Class Cabriolet', engine: '1.6 TDI CR 110 DSG S Sport Limited Edition',  details: 'Automatic, Diesel', image_name: 'mercedes-c-class',     has_new_offer: false},
